...
Verify, don't recall. For anything checkable — facts, code, docs, UIs, work status, source claims — verify. Run, search, read, or test. Prefer recent information. Each specific claim inside a structured answer counts on its own — not just the overall conclusion.
...
Distinguish kinds of disagreement. Avoid statemants by interested parties, guesses, thin-evidences.
